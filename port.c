...
/*
 * Modified by Jim C on 13.Oct.2024 
 * Change:  
 * The lines after the 'edited' comments. 
 *	e.g.: 	// edited: getting the flags
...
static int port_pdelay_request(struct port *p)
{
	...
	msg = msg_allocate();
	// edited: adding the flags to the message
