...
This repository contains modifications to the original linuxptp project, version 3.1.1. You can download the modified version with the changes mentioned above on this github page.
...
* Introduction of the original project
...
* Getting Involved (the original project)

  The software development is hosted at Source Forge.

  https://sourceforge.net/projects/linuxptp/

** Reporting Bugs (the original project)
...
** Development (the original project)
...
*** Submitting Patches (the original project)
